      ...
      >
        <div className="p-6">
          ...
          <div
            ...
            onDrop={handleDrop}
            className={cn(
              "mt-6 border-2 border-dashed rounded-lg p-8 flex flex-col items-center justify-center text-center transition-colors duration-200",
              isDragging
                ? "border-primary"
                : "border-border hover:border-primary"
            )}
            style={{
              backgroundColor: isDragging ? "var(--brand-alpha-weak)" : "transparent",
            }}
          >
            <input
              ref={fileInputRef}
            ...
            <Button type="button" variant="outline" size="sm" className="mt-4" onClick={triggerFileSelect}>
              Browse File
            </Button>
          </div>
        </div>
