...
summary: "Create, edit and delete projects in the work section of your PORTOID."
...
summary: "Portoid is a design system that empowers indie creators, small teams, and startups to build web applications."
images:
...
team:
  - name: "Lorant One"
    ...
    linkedIn: "https://www.linkedin.com/company/portoid/"
link: "https://suntreeart.my.id/"
---`,
        language: "tsx",
...
You can use MDX to write the content of your projects. It helps you write rich and dynamic content with minimal code. Some MDX elements will be automatically transformed to Portoid components to integrate better in the design and add additional functionality.
