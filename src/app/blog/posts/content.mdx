---
title: "Updating the content of PORTOID"
...
Social links are rendered on the `/about` page and in the footer based on the array configured in the `social` object. You can set custom icons to each, but don't forget to import them in `src/portoid/icons.ts`. Read the Portoid documentation](https://suntreeart.my.id/docs/icons) for more information.
...
`const social = [
    {
      name: "GitHub",
      icon: "github",
      link: "https://github.com/Mrmarc-bit/portoid",
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:lorant@suntreeart.my.id",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Maruf Muchlisin's Portfolio",
