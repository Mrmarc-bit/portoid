---
title: "SEO settings for PORTOID"
summary: "Manage your PORTOID's SEO settings."
...
PORTOID automatically generates meta- and open graph tags for your pages based on the `content.js` file.

## Schema

PORTOID automatically generates schema tags for your pages based on the `content.js` file.
